...
export const translations = {
  en: {
    ...
    'footer.about': 'BIKS Trading Company is a trusted Japanese vehicle exporter, supplying high-quality new and used vehicles worldwide with reliable inspection, shipping, and export services.',
    ...
    'footer.designed': 'Designed & Developed by AIWA Logic',
  ...
  ja: {
    ...
    // Footer
    'footer.about': 'BIKS Trading Companyは、厳格な点検と安心の海上輸送で、世界各地へ高品質な新車・中古車および重機をお届けする信頼の日本輸出商社です。',
    'footer.company': '企業情報',
